...
def build_developer_prompt(*, timezone_name: str, preference_snapshot: str, recent_reminders: list[str], pending_state: PendingConversationState | None) -> str:
